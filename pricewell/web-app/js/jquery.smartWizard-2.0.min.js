...
(function($){
    $.fn.smartWizard = function(action) {
        ...
        return this.each(function(){
                ...
                var contentWidth = 0;
                var loader,msgBox,elmActionBar,elmStepContainer,btNext,btPrevious,btFinish, btApprove, btReject, btPreviousStage;
                ...
                function init(){
                  ...
                  if(options.previousStageEnabled)
                  {
                	  btPreviousStage = $('<a>'+options.labelPreviousStage+'</a>').attr("href","#").addClass("buttonPreviousStage");
                	  
                	  $(btPreviousStage).click(function() {
                		  if(!$(this).hasClass('buttonDisabled')){
                              if($.isFunction(options.onPreviousStage)) {
                                 if(!options.onPreviousStage.call(this,$(steps))){
                                   return false;
                                 }
                              }else{
                  ...
                  if(options.approveEnabled){
                	  ...
                	  btReject = $('<a>'+options.labelReject+'</a>').attr("href","#").addClass("buttonReject");
                  ...
                  if(options.previousStageEnabled)
                  {
            		  elmActionBar.append(btPreviousStage);
                  }
                ...
                function adjustButton(){
                  if(!options.cycleSteps)
                  {
                	  /*if(options.enablePreviousButton)
                	  {
                		  if(-1 >= curStepIdx){
                    ...
                    if((steps.length-1) <= curStepIdx){
                      ...
                      $(btFinish).removeClass("buttonDisabled").removeClass("buttonHide");
                      
                      $(btApprove).removeClass("buttonDisabled").removeClass("buttonHide");
                      $(btReject).removeClass("buttonDisabled").removeClass("buttonHide");
                      
                    }else{
                      $(btNext).removeClass("buttonDisabled");
                      $(btNext).removeClass("buttonHide");
                      $(btFinish).addClass("buttonDisabled").addClass("buttonHide");
                      
                      $(btApprove).addClass("buttonDisabled").addClass("buttonHide");
                      $(btReject).addClass("buttonDisabled").addClass("buttonHide");
                    }
                  }
                  // Finish Button
                  /*if(options.approveEnabled){
    ...
    $.fn.smartWizard.defaults = {
          ...
          labelReject:'Reject',
          labelPreviousStage: '< Back Stage',
          onLeaveStep: null, // triggers when leaving a step
          onShowStep: null,  // triggers when showing a step
          onFinish: null,  // triggers when Finish button is clicked
          onPrevious: null//triggers when Previous button is clicked
    };    
