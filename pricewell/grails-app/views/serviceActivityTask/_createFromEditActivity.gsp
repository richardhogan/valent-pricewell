...
<html>
    <script>
		...
		{
			jQuery("#createActivityTaskFromEditActivity").validate();
			jQuery("#saveTaskFromEditActivity").click(function()
			{
				if(jQuery("#createActivityTaskFromEditActivity").validate().form())
				{
					showLoadingBox();
					jQuery.ajax({
						type: "POST",
						url: "${baseurl}/serviceActivityTask/save",
						data:jQuery("#createActivityTaskFromEditActivity").serialize(),
    ...
    <body>
        ...
        <div class="body">
            ...
            <g:form action="save" name="createActivityTaskFromEditActivity">
                ...
                <div class="buttons">
                	<span class="button"><button id="saveTaskFromEditActivity" title="Save Task"> Save </button></span>
                </div>
            </g:form>
        </div>
