...
<html>
    <head>
		...
		<script>
		 	jQuery(function() 
		 	{				 
			    jQuery("#deliveryRoleEdit").validate();	
			    jQuery("#deliveryRoleEdit input:text")[0].focus();		  

			    jQuery("#saveDeliveryRole").click(function()
				{
					if(jQuery("#deliveryRoleEdit").validate().form())
					{
						showLoadingBox();
						jQuery.ajax(
						{
							...
							data:jQuery("#deliveryRoleEdit").serialize(),
							success: function(data)
							{
								...
								{								    		         
									window.location = "${baseurl}/deliveryRole/show/${deliveryRoleInstance?.id}";
								}
								else{
    ...
    <body>
        <div class="nav">
            ...
            <span><g:link class="buttons.button button" title="Create Delivery Role" action="create"><g:message code="default.new.label" args="[entityName]" /></g:link></span>
        </div>
        <div class="body">
        	...
        	<div class="collapsibleContainer">
				...
				<div class="collapsibleContainerContent">
		            ...
		            <g:form method="post" name="deliveryRoleEdit">
		                ...
		                <div class="buttons">
		                    <!-- <span class="button"><g:actionSubmit title="Update Delivery Role" class="save" action="update" value="${message(code: 'default.button.update.label', default: 'Update')}" /></span> -->
		                    <span class="button"><button title="Update Delivery Role" id="saveDeliveryRole"> Update </button></span>
		                    <span class="button"><g:actionSubmit class="delete" title="Delete Delivery Role" action="delete" value="${message(code: 'default.button.delete.label', default: 'Delete')}" onclick="return confirm('${message(code: 'default.button.delete.confirm.message', default: 'Are you sure?')}');" /></span>
		                </div>
		            </g:form>
