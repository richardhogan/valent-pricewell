				...
				<td>
					<div class="menu">
						...
						<ul>
							...
							<li><a class="submenu"
								href="<g:createLink controller='reports' action="totalUnitsSold"/>">Total Units sold per Service</a></li>
							<li><a class="submenu"
								href="<g:createLink controller='reports' action="totalUnitsSold"/>">Total Estimated benefits</a></li>							
						</ul>
						<br/>
						<br/>
						<br/>
