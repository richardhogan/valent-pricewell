...
<g:if test="${roleInstance.code=='SYSTEM ADMINISTRATOR'}">
...
<g:elseif test="${roleInstance.code=='PORTFOLIO MANAGER'}">
...
<g:elseif test="${roleInstance.code=='PRODUCT MANAGER'}">
...
<g:elseif test="${roleInstance.code=='SERVICE DESIGNER'}">
...
<g:elseif test="${roleInstance.code=='GENERAL MANAGER'}">
...
<g:elseif test="${roleInstance.code=='SALES PRESIDENT'}">
...
<g:elseif test="${roleInstance.code=='DELIVERY ROLE MANAGER'}">
