...
<html>
    <head>
			    ...
			    jQuery( ".dvUploadLogo" ).dialog(
			 	{
					...
					autoOpen: false,
					resizable: false,
					zIndex: 4050,close: function( event, ui ) {
						jQuery(this).html('');
					}
				});
						...
						showLoadingBox();
    	   				jQuery.post( '${baseurl}/account/save', 
						      ...
						      function( data ) 
						      {
							      ...
							      {
							      		jAlert('Account creation failed.', 'Alert Message'); 
							      }
        ...
        <div class="body">
            ...
            <g:form action="save" name="accountCreate">
                ...
                <!-- <div class="buttons">
                    <span class="button"><button title="Save Account" id="save">Save</button></span>
                </div> -->
                
                <div class="buttons">
                    <span class="button"><input type="button" id="saveBtn" class="saveBtn" name="save" title="Save Account" value="Save"/></span>
