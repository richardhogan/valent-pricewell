	...
	<div id="mainInformationTab">
		...
		<script>
			...
			jQuery(document).ready(function()
		 	{			
				jQuery("#createInstanceInformationFrm").validate();
				
				jQuery( "#btnSave" ).click(function() 
				{
					if(jQuery("#createInstanceInformationFrm").validate().form())
					{
						showLoadingBox();
						jQuery.ajax({type:'POST',
							 url:"${baseurl}/companyInformation/saveInstanceInfo",
							 data: jQuery("#createInstanceInformationFrm").serialize(),
        ...
        <div class="body">
        	<div class="collapsibleContainer">
				...
				<div class="collapsibleContainerContent ui-widget-content">
					...
					<g:form action="save" name="createInstanceInformationFrm">
			                ...
			                <table>
			                    <tbody>
			                    	...
			                    	<tr class="prop">
			                            ...
			                            <td valign="top" class="value"><g:textField name="instanceName" value="" class="required"/></td>
			            ...
			            <div class="buttons">
			                <button id="btnSave" title="Save Instance Information">Save</button>
			            </div>
		            </g:form>
		        </div>
