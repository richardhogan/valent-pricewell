        ...
        <div class="body">
            ...
            <div class="collapsibleContainer">
				...
				<div class="collapsibleContainerContent">
					...
					<g:uploadForm method="post"  enctype="multipart/form-data" name="editCompanyInformation">
		                        ...
		                        <tbody>
		                            ...
		                            <tr class="prop">
		                                ...
		                                <td valign="top" class="value ${hasErrors(bean: companyInformationInstance, field: 'logo', 'errors')}">
		                                    ...
		                                    </div><button id="btnChange">Change Logo</button>
		                                </td>
		                            </tr>
		                ...
		                <div class="buttons">
		                    <span class="button"><g:actionSubmit class="save" title="Update Company Information" action="update" value="${message(code: 'default.button.update.label', default: 'Update')}" onclick="if(jQuery('#logoId').val() == ''){jAlert('Company Logo is mandatory field, Please add Logo first.', 'Create Company Information Alert');return false;}"/></span>
