	  		...
	  		{		  		
					...
					buttons: {
						...
						{							 
							...
							jQuery.ajax({type:'POST',data: {territoryId: territoryId},
			   					url:'${baseurl}/setting/SOWTemplates',
				...
				jQuery( ".importSOWBtn" ).click(function() 
				{
					jQuery.ajax({type:'POST',
	   					url:'${baseurl}/setting/importSOWTemplate',
		...
		<div>
			<g:if test="${!isFile}">
   			...
   			<g:else>
   				...
   				<button id="helpBtn" class="helpBtn buttons.button button" title="Help">SOW Tags</button>
   				<!--<g:link controller="setting" action="downloadSOWPreview" class="buttons.button button" title="Download Preview" id="${geoInstance?.id }" >Download</g:link>-->
