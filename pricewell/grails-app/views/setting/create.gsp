                    ...
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: settingInstance, field: 'name', 'errors')}">
                                    <g:textField name="name" value="${settingInstance?.name}" />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: settingInstance, field: 'value', 'errors')}">
                                    <g:textField name="value" value="${settingInstance?.value}" />
                                </td>
                            </tr>
