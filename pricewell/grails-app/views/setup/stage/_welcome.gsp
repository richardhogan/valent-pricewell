...
<r:script>
	...
	jQuery(document).ready(function(){
  		...
  		jQuery('#wizard').smartWizard({contentURL:'${baseurl}/setup/showStage?source=welcome'  ,contentCache:false,  onLeaveStep:leaveAStepCallback, onShowStep: showStepCallback, selected:  <%=currentStepNo - 1%>, labelFinish:'Add Company Info', onFinish:onFinishCallback });
...
<div id="wizard" class="swMain">
			<ul>
				<g:each var="step" status="i" in="${ServiceStageFlow.setupSteps['welcome']}">
					<li><a href="#step-${i+1}">
