...
<r:script>
	...
	jQuery(document).ready(function(){
  		...
  		jQuery('#wizard').smartWizard({contentURL:'${baseurl}/setup/showStage?source=geos'  ,contentCache:false,  onLeaveStep:leaveAStepCallback, onShowStep: showStepCallback, selected:  <%=currentStepNo - 1%>, labelFinish:'Create Users', onFinish:onFinishCallback });
...
<div id="wizard" class="swMain">
			<ul>
				<g:each var="step" status="i" in="${ServiceStageFlow.setupSteps['geos']}">
					<li><a href="#step-${i+1}">
