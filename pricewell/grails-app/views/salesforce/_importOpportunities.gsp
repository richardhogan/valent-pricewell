...
%>	
        <g:set var="entityName" value="${message(code: 'cw.label', default: 'Salesforce')}" />
			...
			jQuery(document).ready(function()
		 	{
				...
				jQuery( "#importSaveBtn" ).click(function() 
				{					
					if(jQuery('#importOpportunitiesFrm').validate().form())
					{
						showLoadingBox();
    	   				...
    	   				jQuery.ajax(
						{
			                url: '${baseurl }/salesforce/saveOpportunitiesFromSalesforce',
			                type: 'POST',
        ...
        <div class="body">
            ...
            <g:form action="saveOpportunitiesFromConnectwise"  name="importOpportunitiesFrm">
                   	...
                   	<table>
               			<tbody>
							...
							<!--<tr class="prop">
								...
								<tr class="prop">
									<td valign="top" class="name">
									    <label for="dateRange">Last Imported Time</label>
									</td>
									<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
									<td valign="top" class="value">
									    <g:formatDate format="MMMMM d, yyyy HH:mm:ss z" date="${lastUpdateRecord?.lastUpdateDate}" />
									</td>
								</tr>
                ...
                <div class="buttons">
                    <span class="button"><button id="importSaveBtn" title="Import Opportunities">Import</button></span>
                </div>
            </g:form>
        </div>
