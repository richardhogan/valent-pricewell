...
%>	
			...
			jQuery(document).ready(function()
		 	{
				...
				jQuery( "#importSalesforceOpportunitiesBtn" ).click(function() 
				{					
        ...
        <div class="body">
            ...
            <g:form action="saveOpportunitiesFromSalesforce"  name="importOpportunitiesFrm">
                ...
                <div class="buttons">
                    <span class="button"><button id="importSalesforceOpportunitiesBtn" title="Import Opportunities">Import</button></span>
                </div>
            </g:form>
        </div>
