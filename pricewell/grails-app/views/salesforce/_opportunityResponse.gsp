	...
	<div class="list">
	    <table cellpadding="0" cellspacing="0" border="0" class="display">
	        ...
	        <tbody>
		        ...
		        <g:each in="${updatedOpportunities}" status="j" var="uOpportunityInstance">
		            <tr>
		            
		                <td>${fieldValue(bean: uOpportunityInstance, field: "id")}</td>
		            
		                <td>${fieldValue(bean: uOpportunityInstance, field: "name")}</td>
		            
		                <td>Already Exist - Amount Updated</td>
