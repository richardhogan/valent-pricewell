    ...
    <body>
        ...
        <div class="body">
            ...
            <g:form action="save" >
                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: serviceQuotationInstance, field: 'geo', 'errors')}">
                                    <g:select name="geo.id" from="${com.valent.pricewell.Geo.list()}" optionKey="id" value="${serviceQuotationInstance?.geo?.id}" noSelection="['null': '']" onchange="document.getElementById('btnCalculate').click();"/>
                                </td>
                ...
                <div class="buttons">
                    <span class="button"><g:submitButton name="create" class="save" value="Add" />
                    					<g:link controller="quotation" action="show" class="show" value="Cancel" id="${serviceQuotationInstance?.quotation?.id}" params="[tab:'add']"> Cancel </g:link>
                    </span>
                </div>
            </g:form>
        </div>
