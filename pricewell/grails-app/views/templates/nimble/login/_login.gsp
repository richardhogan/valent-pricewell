			  ...
			  {	
			  	jQuery("#dvForgotPass").dialog(
					...
					jQuery("#forgotPass").click(function() 
					{
							...
							jQuery("#dvForgotPass").dialog( "option", "title", 'Forgot Password' );
							//jQuery('#dvForgotPass').html("Loading Data, Please Wait.....");
							jQuery("#dvForgotPass").dialog( "open" );
							
							/*jQuery.ajax({type:'POST',
							 url:'${baseurl}/userSetup/reset',
							 success:function(data,textStatus){jQuery('#dvForgotPass').html(data);},
          ...
          <div id="local" class="loginmethod">
            ...
            <g:form id="locallogin" action="signin" name="signin">
              <fieldset>
                ...
                <input id="password" type="password" name="password" class="title" onpaste="return false;"/>
              </fieldset>
              ...
              <!-- <fieldset class="loginbuttons">
				...
				<fieldset class="loginbuttons">
		            <button type="submit" title="Login" class="button icon icon_user_green"><g:message code="nimble.link.login.basic" /></button>
		            <button id="forgotPass" title="Forgot Password" class="button icon icon_flag_purple">Forgot Password</button>
		        </fieldset>
            </g:form>
