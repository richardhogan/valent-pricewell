...
<html>
    ...
    <body>
        ...
        <div class="body">
            <h2>Add territory and primary contact in opportunity</h2><hr>
            
            <b>Note : Territory and Primary Contact not defined in opportunity : ${opportunityInstance?.name} so add it first. This is Salesforce imported opportunity.</b>
            
            <g:form action="saveTerritory" name="addTerritoryFrm">
            	<g:hiddenField name="id" value="${opportunityInstance?.id}"/>
            	<g:hiddenField name="sourceFrom" value="salesforceImport"/>
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="name">
                                    <label for="primaryContact"><g:message code="default.primaryContact.label" default="Primary Contact" /></label><em>*</em>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: opportunityInstance, field: 'primaryContact', 'errors')}">
                                    <g:select name="primaryContactId" from="${opportunityInstance?.account?.contacts?.sort {it.firstname}}" optionKey="id" value="${primaryContact?.id}" class="required" noSelection="['': 'Select Any One']" />
                                </td>
