		...
		<div class="body">
        	...
        	<div class="collapsibleContainer">
				...
				<div class="collapsibleContainerContent">
		            ...
		            <g:form action="save" name="geoGroupCreate" >
		                <div class="dialog">
		                    <table>
		                        <tbody>
		                            ...
		                            <tr class="prop">
		                                ...
		                                <td valign="top" class="value ${hasErrors(bean: geoGroupInstance, field: 'name', 'errors')}">
		                                    <g:textField id="name" name="name" value="${geoGroupInstance?.name}" class="required" />
		                                </td>
		                            </tr>
		                        	...
		                        	<g:if test="${generalManagerList.size() > 0}">
			                        	<tr>
								          ...
								          <td valign="top">
								          	<g:select name="generalManagerId" from="${generalManagerList?.sort {it.profile.fullName}}" optionKey="id" value=""  noSelection="['':'Select Any One...']" class="required" />
								          </td>
								        </tr>
							        </g:if>
		                        	...
		                        	<tr>
							          ...
							          <td valign="top">
							          	<div id="territoriesList">
							          		<g:select name="geos" from="${territoriesList?.sort {it.name}}" optionKey="id" size="5" value=""  noSelection="['':'Select Multiple...']" class="required" multiple="true"/>
						          		</div>	<button id="newterritory" title="Create New Territory">Create Territory</button>
		                ...
		                <div class="buttons">
		                    <span class="button"><g:submitButton name="create" title="Save GEO" class="save" value="${message(code: 'default.button.create.label', default: 'Create')}" /></span>
		                </div>
		            </g:form>
