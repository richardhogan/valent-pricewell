	...
	<div class="body">
		<div class="collapsibleContainer">
			...
			<div class="collapsibleContainerContent ui-widget-content">
				<g:render template="serviceImport/stageProgress" model="['serviceProfileInstance': serviceProfileInstance, 'importServiceStages': importServiceStages]"> </g:render>
				
				<g:if test="${serviceProfileInstance.id == null}">
					<g:render template="serviceImport/init" model="['serviceProfileInstance': serviceProfileInstance]"/>
				</g:if>
				<g:else>
					<g:render template="serviceImport/${serviceProfileInstance.importServiceStage }" model="['serviceProfileInstance': serviceProfileInstance]"/>
				</g:else>
			</div>
