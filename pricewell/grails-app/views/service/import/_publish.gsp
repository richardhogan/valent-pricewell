...
<script>
	...
	jQuery(document).ready(function()
	{
  		...
  		jQuery('#wizard').smartWizard({contentURL:'${baseurl}/service/showImportStages?source=publish&id=' + ${serviceProfileInstance?.id}  ,contentCache:false,  onLeaveStep:leaveAStepCallback, onShowStep: showStepCallback, selected:  ${serviceProfileInstance?.currentStep - 1}, labelFinish:'Publish Service', onFinish:onFinishCallback });
...
<div id="wizard" class="swMain">
			<ul>
				<g:each var="step" status="i" in="${importServiceStageSteps['publish']}">
					<li><a href="#step-${i+1}">
