...
<script>
	...
	jQuery(document).ready(function(){
  		...
  		jQuery('#wizard').smartWizard({contentURL:'${baseurl}/service/showServiceImportStages?source=concept&id=' + ${serviceProfileInstance?.id}  ,contentCache:false,  onLeaveStep:leaveAStepCallback, onShowStep: showStepCallback, selected:  ${serviceProfileInstance?.currentStep - 1}, labelFinish:'Design >>', onFinish:onFinishCallback });
...
<div id="wizard" class="swMain">
			<ul>
				<g:each var="step" status="i" in="${ServiceStageFlow.importServiceStageSteps['concept']}">
					<li><a href="#step-${i+1}">
