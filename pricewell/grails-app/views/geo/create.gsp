        	...
        	<div class="collapsibleContainer">
				...
				<div class="collapsibleContainerContent">
		            ...
		            <g:form action="save" name="geoCreate">
		                        ...
		                        <tbody>
		                            ...
		                            <tr class="prop">
		                                ...
		                                <td valign="top" class="value ${hasErrors(bean: geoInstance, field: 'description', 'errors')}">
		                                    <g:textField name="description" value="${geoGroupInstance?.description}" size='75' />
		                                </td>
		                            </tr>
		                        	...
		                        	<tr>
										<g:if test="${salesManagerList.size() > 0}">
									          ...
									          <td valign="top">
									          	<g:select name="salesManagerId" from="${salesManagerList?.sort {it.profile.fullName}}" optionKey="id" value=""  noSelection="${['':'Select One...']}" class="required" />
									          </td>
									          <td>&nbsp;&nbsp;</td>
							            </g:if>
		                            ...
		                            <tr class="prop">
		                                ...
		                                <td valign="top" class="value ${hasErrors(bean: geoInstance, field: 'currency', 'errors')}">
		                                    <!--<g:textField name="currency" value="${geoInstance?.currency}" class="required"/>-->
		                ...
		                <div class="buttons">
		                    <span class="button"><g:submitButton name="create" title="Save Territory" class="save" value="${message(code: 'default.button.create.label', default: 'Create')}" /></span>
		                </div>
		            </g:form>
