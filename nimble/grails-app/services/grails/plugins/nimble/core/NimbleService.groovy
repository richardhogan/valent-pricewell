...
class NimbleService {
    ...
    public void init() {
        ...
        if (!userRole) {
			...
			userRole.code = UserService.USER_ROLE
            userRole.protect = false // initially it was true, on requirement it made false
            userRole.save()
        ...
        if (!adminRole) {
			...
			adminRole.code = AdminsService.ADMIN_ROLE
            adminRole.protect = false // initially it was true, on requirement it made false
            adminRole.save()
