...
<body>
    ...
    <g:form action="saveuser" name="createUser">
      <table>
        <tbody>
        ...
        <tr>
          ...
          <td valign="top" class="value ${hasErrors(bean: user, field: 'username', 'errors')}">
			<n:verifyfield id="username" class="easyinput" name="username" value="${fieldValue(bean: user, field: 'username')}" class="required" controller="account" action="validusername" validmsg="valid" invalidmsg="invalid" />
        ...
        <tr>
          ...
          <td valign="top" class="value ${hasErrors(bean: user, field: 'pass', 'errors')}">
            <input type="password" size="30" id="pass" name="pass" value="${user.pass?.encodeAsHTML()}" class="password easyinput required"/> <span class="icon icon_bullet_green">&nbsp;</span><a href="#" id="passwordpolicybtn" rel="passwordpolicy" class="empty icon icon_help"></a>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td valign="top" class="value ${hasErrors(bean: user, field: 'passConfirm', 'errors')}">
            <input type="password" size="30" id="passConfirm" name="passConfirm" value="${user.passConfirm?.encodeAsHTML()}" class="easyinput required"/> <span class="icon icon_bullet_green">&nbsp;</span>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td valign="top" class="value ${hasErrors(bean: user, field: 'profile.email', 'errors')}">
            <input type="text" size="30" id="email" name="email" value="${user.profile?.email?.encodeAsHTML()}" class="easyinput required email"/> <span class="icon icon_bullet_green">&nbsp;</span>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td valign="top" class="value ${hasErrors(bean: user, field: 'primaryGeo', 'errors')}">
          	<g:select name="primaryGeo.id" from="${com.valent.pricewell.Geo.list()}" optionKey="id" value="" noSelection="['': 'Select any one']"  class="required"/>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td valign="top">
          	<g:select name="geos.id" from="${com.valent.pricewell.Geo.list()}" optionKey="id" value="" noSelection="['': '']" multiple="true"/>
          </td>
        </tr>
