...
<body>
  ...
  <g:form action="save" method="post">
    ...
    <table>
      ...
      <tr>
        <th><g:message code="nimble.label.code" /></th>
        <td class="value">
          <input type="text" id="code" size="30" name="code" value="${fieldValue(bean: role, field: 'code')}" class="easyinput"/><span class="icon icon_bullet_green">&nbsp;</span>
        </td>
      </tr>
